...
# Here I choose 3 packages.
# 2 adapted from python (optparse and argparse) and 1 specific to R (argparser).

# Others packages that you can test:
# - getopt (C-like getopt behavior),
# - docopt (it's a port a docopt.py),
# - minimist (JavaScript library),
# - optigrab (GNU-, Java- or Microsoft- style syntaxes supported)
